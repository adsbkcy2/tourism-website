          ...
          <Grid container spacing={4}>
            <Grid item xs={12} sm={6} md={3}>
              <Box sx={{ textAlign: 'center', p: 3 }}>
                ...
                <Typography variant="body2" color="text.secondary">
                  نضمن لك أفضل الخدمات وأعلى مستويات الراحة والرفاهية
                </Typography>
              </Box>
            </Grid>
            <Grid item xs={12} sm={6} md={3}>
              <Box sx={{ textAlign: 'center', p: 3 }}>
                ...
                >
                  <img src="https://img.icons8.com/fluency/48/000000/best-price.png" alt="أسعار تنافسية" />
                </Box>
                <Typography variant="h5" sx={{ fontWeight: 600, mb: 1 }}>
                  أسعار تنافسية
                </Typography>
                <Typography variant="body2" color="text.secondary">
                  نقدم أفضل الأسعار التنافسية مع ضمان جودة الخدمات
                </Typography>
              </Box>
            </Grid>
            <Grid item xs={12} sm={6} md={3}>
              <Box sx={{ textAlign: 'center', p: 3 }}>
                ...
                >
                  <img src="https://img.icons8.com/fluency/48/000000/support.png" alt="دعم على مدار الساعة" />
                </Box>
                <Typography variant="h5" sx={{ fontWeight: 600, mb: 1 }}>
                  دعم 24/7
                </Typography>
                <Typography variant="body2" color="text.secondary">
                  فريق دعم متكامل على مدار الساعة لمساعدتك في أي وقت
                </Typography>
              </Box>
            </Grid>
            <Grid item xs={12} sm={6} md={3}>
              <Box sx={{ textAlign: 'center', p: 3 }}>
                ...
                >
                  <img src="https://img.icons8.com/fluency/48/000000/experience.png" alt="خبرة طويلة" />
                </Box>
                <Typography variant="h5" sx={{ fontWeight: 600, mb: 1 }}>
                  خبرة طويلة
                </Typography>
                <Typography variant="body2" color="text.secondary">
                  نمتلك خبرة طويلة في مجال السياحة والسفر تمتد لسنوات
                </Typography>
              </Box>
            </Grid>
          </Grid>
      ...
      <Box sx={{ py: 12, bgcolor: '#f8f9fa' }}>
        <Container maxWidth="lg">
          <Box sx={{ textAlign: 'center', mb: 6 }}>
            ...
            <Typography variant="body1" sx={{ mt: 3, mb: 2, maxWidth: '700px', mx: 'auto' }}>
              استمع إلى تجارب عملائنا السابقة وآرائهم حول خدماتنا
            </Typography>
          </Box>
        ...
        <Container maxWidth="md">
          <Box sx={{ textAlign: 'center' }}>
            ...
            <Typography variant="body1" sx={{ mb: 4 }}>
              احصل على أحدث العروض والرحلات مباشرة إلى بريدك الإلكتروني
            </Typography>
            <Box 
              sx={{ 
                display: 'flex',
