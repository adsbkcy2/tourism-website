        ...
        <Container maxWidth="lg">
          <Grid container spacing={4}>
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center', mb: 4 }}>
                        ...
                        <Box sx={{ ml: 2, display: 'flex', alignItems: 'center' }}>
                          ...
                          <Typography variant="body1" sx={{ ml: 1 }}>
                            {tourData.rating} ({tourData.reviewsCount} تقييم)
                          </Typography>
                        </Box>
                      </Box>

                      {tourData.reviews.map((review) => (
                        <Box key={review.id} sx={{ mb: 4, pb: 4, borderBottom: '1px solid #eee' }}>
            ...
            <Grid item xs={12} md={4}>
              ...
              <Paper sx={{ p: 3, borderRadius: '16px', mb: 4 }}>
                ...
                <Box sx={{ mb: 2 }}>
                  ...
                  <Box sx={{ 
                    ...
                    <Typography>اختر عدد المسافرين</Typography>
                  </Box>
                </Box>
                <Box sx={{ mb: 3 }}>
                  <Typography variant="subtitle1" sx={{ fontWeight: 600, mb: 1 }}>
                  ...
                  <Box sx={{ 
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                      <Typography>سعر الشخص الواحد</Typography>
                      <Typography fontWeight={600}>{tourData.discountPrice || tourData.price} $</Typography>
                    </Box>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                      <Typography>عدد المسافرين</Typography>
                      <Typography fontWeight={600}>1</Typography>
                    </Box>
                    <Divider sx={{ my: 1 }} />
                    <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                      <Typography fontWeight={600}>المجموع</Typography>
                      <Typography fontWeight={700} color="primary.main">{tourData.discountPrice || tourData.price} $</Typography>
                    </Box>
                  </Box>
                </Box>
                <Button 
              ...
              {/* Need Help */}
              <Paper sx={{ p: 3, borderRadius: '16px', mb: 4, bgcolor: 'primary.main', color: 'white' }}>
                <Typography variant="h5" sx={{ fontWeight: 600, mb: 2 }}>
                  بحاجة إلى مساعدة؟
                </Typography>
